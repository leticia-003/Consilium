...
CREATE TABLE CORE.USER_LOG (
    ...
    USER_LOG_UPDATED_AT TIMESTAMP NOT NULL,
    ...
    -- FK 2: USUÁRIO QUE FEZ A ALTERAÇÃO
...
CREATE TABLE LEGAL.PROCESS_LOG (
    ...
    -- RASTREIO DE USUÁRIO
    PROCESS_LOG_UPDATED_BY UUID NOT NULL,
    ...
    -- FK 2: O Usuário que FEZ a alteração
...
CREATE TABLE LEGAL.DOCUMENT (
    ...
    -- FK para o Criador
    DOCUMENT_CREATED_BY UUID NOT NULL,
    ...
    -- FOREIGN KEY 1: Referência ao Processo
    CONSTRAINT FK_DOCUMENT_PROCESS_01 FOREIGN KEY (PROCESS_ID)
        REFERENCES LEGAL.PROCESS (PROCESS_ID)
        ON DELETE RESTRICT,

    -- FOREIGN KEY 2: Referência ao Usuário Criador
...
CREATE TABLE COMMS.CHAT (
    ...
    -- UNIQUE KEY: Garante que um processo não tenha dois chats registrados no mesmo horário
